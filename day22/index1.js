...
function noOverlap(a,b) {
  let ret = true;
  let sizeX = Math.max(Math.min(a[1][0],b[1][0])-Math.max(a[0][0],b[0][0]),0);
  let sizeY = Math.max(Math.min(a[1][1],b[1][1])-Math.max(a[0][1],b[0][1]),0);
  let sizeZ = Math.max(Math.min(a[1][2],b[1][2])-Math.max(a[0][2],b[0][2]),0);
...
function explode(box,ind) {
  ...
  if(cutX.length===2) {
    unBox.push([[unB[0][0],unB[0][1],unB[0][2]],[cutX[0],unB[1][1],unB[1][2]],unB[2]]);
    unBox.push([[cutX[1],unB[0][1],unB[0][2]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
    ...
    if(a===1) {
      ...
      unBox.push([[cutX[0],unB[0][1],unB[0][2]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
  ...
  if(cutY.length===2) {
    unBox.push([[unB[0][0],unB[0][1],unB[0][2]],[unB[1][0],cutY[0],unB[1][2]],unB[2]]);
    unBox.push([[unB[0][0],cutY[1],unB[0][2]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
    ...
    if(a===1) {
      ...
      unBox.push([[unB[0][0],cutY[0],unB[0][2]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
  ...
  if(cutZ.length===2) {
    unBox.push([[unB[0][0],unB[0][1],unB[0][2]],[unB[1][0],unB[1][1],cutZ[0]],unB[2]]);
    unBox.push([[unB[0][0],unB[0][1],cutZ[1]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
    ...
    if(a===1) {
      ...
      unBox.push([[unB[0][0],unB[0][1],cutZ[0]],[unB[1][0],unB[1][1],unB[1][2]],unB[2]]);
